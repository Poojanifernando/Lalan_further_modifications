...
function LineHeader(props) {
    ...
    const handleClick1 = async (id) => {
            ...
            if (confirm("Are you want to pause this?")) {
                ...
                try {
                    ...
                    if (option) {
                        ...
                        axios.get(url + '/api/v1/admin/HoldProduction/' + current_Line + '/' + id + '/' + "1" + '/' + UserId + '/' + option).then(() => {
        ...
        //resume
            ...
            if (confirm("Are you want to resume this?")) {
                ...
                try {
                    axios.get(url + '/api/v1/admin/HoldProduction/' + current_Line + '/' + id + '/' + "2" + '/' + UserId + "/reson resume").then(() => {
    ...
    const getCompletedRollCount = async () => {
        ...
        try {
            const response1 = await axios.get(url + '/api/v1/admin/getsumofproduct/' + current_Line);
            const sumOfLenght = response1.data.IOT;
            setSumLength(sumOfLenght);

            const response2 = await axios.get(url + '/api/v1/admin/GetDetailsByDateAndLineId/' + current_date + '/' + current_Line);
            ...
            axios.get(url + '/api/v1/admin/getCompletedCountandDate/' + proOrder + '/' + current_Line + '/' + compltedRollCount).then(() => {
                    ...
                    return (
                        <>
                            <div class="row1">
                                ...
                                <div >
                                    ...
                                    <div class="columnrowbtnpadding">
                                        <button onClick={() => handleClick1(cusDetails.production_order)} className='startBtn' disabled={boolValue} >
                                            {isRunning == 1
                                                ? 'WARMUP'
                                                : isRunning == 2
                                                    ? 'START'
                            ...
                            <div class="row1" >
                                ...
                                <div class="column1"><p className="linetitle">TOTAL LENGTH :<p className="ptagRemove"> {cusDetails.count_reg_bch}m</p></p>  </div>
                                <div class="column1"><p className="linetitle">ROLL COUNT :<p className="ptagRemove"> {cusDetails.Number_of_rolls}</p></p>  </div>
                                ...
                                <div class="column1"><p className="linetitle">WASTAGE : <p className="ptagRemove"> {Wastage}m</p></p></div>
                            </div>
                            <br />

                            <div class="row1" >

                                <div class="column1"><p className="linetitle">COMPLETED ROLL COUNT :<p className="ptagRemove" > {completedRollCount}</p></p></div>
                                <div class="column1"><p className="linetitle">CURRENT ROLL COUNT :<p className="ptagRemove" style={{color : 'red'}}> {currentRollCount} </p></p></div>
                            </div>
